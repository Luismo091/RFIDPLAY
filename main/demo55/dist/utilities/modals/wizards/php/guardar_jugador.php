...
// Obtener el apellido materno.
    ...
    $sql = "INSERT INTO documentos (tipo_documento, numero_documento, Nombre1, Nombre2, Ape1, Ape2, docfile, documentosfoto,rfidcpde) 
            VALUES ('$documentotype', '$documentonum', '$nombre1', '$nombre2', '$ape1', '$ape2', '$selectedFileData', '$selectedImageData','$rfidSensor')";
