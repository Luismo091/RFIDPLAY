                        ...
                        <div class="app-navbar flex-lg-grow-1" id="kt_app_header_navbar">
                            <div class="app-navbar-item d-flex align-items-stretch flex-lg-grow-1 me-1 me-lg-0">
                                ...
                                <div id="kt_header_search" class="header-search d-flex align-items-center w-lg-275px" data-kt-search-keypress="true" data-kt-search-min-length="2" data-kt-search-enter="enter" data-kt-search-layout="menu" data-kt-search-responsive="true" data-kt-menu-trigger="auto" data-kt-menu-permanent="true" data-kt-menu-placement="bottom-start">
                                    ...
                                    <form id="search-form" class="d-none d-lg-block w-100 position-relative mb-5 mb-lg-0" autocomplete="off">
                                        ...
                                        <!--end::Icon-->
                                        <!--begin::Input-->
                                        <input type="text" class="search-input form-control form-control-solid ps-13" name="search" value="" placeholder="Busca cualquier cosa" data-kt-search-element="input" />
                                        <!--end::Input-->
                                        <!--begin::Spinner-->
                                        ...
                                        <div data-kt-search-element="wrapper">
                                            ...
                                            <div class="" data-kt-search-element="main">
                                                ...
                                                <div class="d-flex flex-stack fw-semibold mb-4">
                                                    <!--begin::Label-->
                                                    <span class="text-muted fs-6 me-2">Buscado Recientemente:</span>
                                ...
                                <div class="menu menu-column menu-rounded menu-sub-indention fw-bold px-6" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
                                    ...
                                    <div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
                                        ...
                                        <div class="menu-sub menu-sub-accordion">
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link active" href="../../demo55/dist/utilities/modals/wizards/create-account.php">
                                            ...
                                            $(document).ready(function() {
                                                $("#escuelaSelect").on("change", function() {
                                                    ...
                                                    if (selectedEscuelaId !== "") {
                                                        $.ajax({
                                                            url: "../../demo55/dist/utilities/modals/wizards/php/obtener_equipos.php",  // Cambia esta URL al archivo que obtiene los equipos por escuela
                                                            type: "POST",
                                                            data: { escuelaId: selectedEscuelaId },
                                                            dataType: "json",
                                                            success: function(response) {
                                                                $("#equiposSelect").empty();
                                                                $.each(response, function(index, equipo) {
                                                                    $("#equiposSelect").append('<option value="' + equipo.id_equipo + '">' + equipo.nombre_equipo + '</option>');
                                                                });
                                                                // Actualizar el select2 después de añadir opciones
                                                ...
                                                // Inicializar select2
                                                $("#escuelaSelect, #equiposSelect").select2();
                                            });
                                        </script>
