                    ...
                    <div class="">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                                ...
                                <div class="menu-content d-flex align-items-center px-3">
                                    ...
                                    <div class="d-flex flex-column">
                                        <div class="fw-bold d-flex align-items-center fs-5"><?= $_SESSION['nombredeusu2']; ?>
                                            <span class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2"><?php if (empty($_SESSION['Nombreescu'])) {
                                                    echo '<span class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2">RPLAY ADMIN</span>';
                                                } else {
                                                    echo '<span class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2">ENTRENADOR</span>';
                                                } ?></span></div>
                                        <a href="#"
                            ...
                            <div class="menu-item px-5">
                                <?php if (empty($_SESSION['Nombreescu'])) { ?>

                                <?php } else { ?>
                                    <div class="menu-content d-flex align-items-center px-3">
                                        <div class="symbol symbol-50px me-5">
                                            <img src="data:image/jpg;base64,<?php echo base64_encode($_SESSION['fotoes']) ?>">
                                        </div>
                                        <div class="d-flex flex-column">
                                            <div class="fw-bold d-flex align-items-center fs-5"><?= $_SESSION['Nombreescu']; ?></div>
                                        </div>
                                    </div>
                            ...
                            <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                                <style>
                                    .text-animation {
                                        font-size: 2em;
                                        font-weight: bold;
                                        animation: blurFade 3s ease-in-out forwards;
                                    }
                                ...
                                <span class="text-animation">Bienvenido a Rfidplay</span>
                                        <span class="d-inline-block position-relative ms-2">

                                            <!--begin::Page title-->
										<div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
											<!--begin::Title-->
											<h1 class="page-heading d-flex flex-column justify-content-center text-dark fw-bold fs-3 m-0">Partidos en Vivo</h1>
                                            <!--end::Title-->
                                            <!--begin::Breadcrumb-->
                                ...
                                <div class="card card-flush h-xl-100 mb-xl-10">
                                    ...
                                    <div class="card-header pt-7">
                                        <h3 class="card-title align-items-start flex-column">
                                            <span class="card-label fw-bold text-gray-800">COPA RPLAY SPORTS</span>
                                            <span class="text-gray-400 mt-1 fw-semibold fs-6">EN VIVO</span>
                                        </h3>
                                        <div class="card-toolbar">
                                            <span class="text-gray-400 mt-1 fw-semibold fs-6">Valledupar Cesar</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-body d-flex align-items-center justify-content-center px-0 pt-3 pb-5">
                                        <div class="d-flex align-items-center mr-4">
                                            <div class="mx-6">
                                                <span class="d-block fw-bold">Equipo 1</span>
                                                <span class="d-block text-muted">Descripción del equipo</span>
                                                <i class="fas fa-info-circle"></i>
                                            </div>
                                            <div class="mx-4"></div> <!-- Espacio entre texto y imagen -->
                                            <div class="circle-image">
                                                <img src="assets/media/flags/spain.svg" alt="Equipo 1"
                                                     class="rounded-circle" width="180" height="180">
                                            </div>
                                            <div class="score mx-4" style="font-size: 3rem; font-weight: bold;">3</div>
                                            <!-- Marcador del equipo 1 -->
                                        </div>
                                        <h2 class="mx-4" style="font-size: 2rem;">-</h2>
                                        <div class="d-flex align-items-center">
                                            <div class="score mx-4" style="font-size: 3rem; font-weight: bold;">2</div>
                                            <!-- Marcador del equipo 2 -->

                                            <div class="mx-4"></div> <!-- Espacio entre marcador y texto -->
                                            <div class="circle-image">
                                                <img src="assets/media/flags/spain.svg" alt="Equipo 2"
                                                     class="rounded-circle" width="180" height="180">
                                            </div>

                                            <div class="mx-6">
                                                <span class="d-block fw-bold">Equipo 2</span>
                                                <span class="d-block text-muted">Descripción del equipo</span>
                                                <i class="fas fa-info-circle"></i>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-body text-center">
                                        <h3 class="card-title align-items-start flex-column">
                                            <span class="badge py-3 px-8 fs-7 badge-light-warning">RECESO - MITAD DE TIEMPO</span>
                                        </h3>
                                    </div>
                                    <div class="card-footer d-flex justify-content-between px-5 py-3">
                                        <div class="text-gray-400 mt-1 fw-semibold fs-6">Esquina Inferior Izquierda
                                        </div>
                                        <div class="text-gray-400 mt-1 fw-semibold fs-6">Centro</div>
                                        <div class="text-gray-400 mt-1 fw-semibold fs-6">Esquina Inferior Derecha</div>
                                    </div
                                    ...
                                    <div class="card-body d-flex flex-column flex-center">
                                        ...
                                        <div class="text-center mb-1">
                                            ...
                                            <a class="btn btn-sm btn-primary me-2"
                                               data-bs-target="#kt_modal_new_address" data-bs-toggle="modal">Try Now</a>
                                            <!--end::Link-->
                                            <!--begin::Link-->
                                            <a class="btn btn-sm btn-light"
                                               href="../../demo55/dist/apps/user-management/users/view.html">Learn
                                                More</a>
                                            <!--end::Link-->
                                        </div>
                                        <!--end::Links-->
                ...
                <div class="stepper stepper-links d-flex flex-column" id="kt_modal_create_campaign_stepper">
                    ...
                    <div class="stepper-nav justify-content-center py-2">
                        ...
                        <div class="stepper-item me-5 me-md-15 current" data-kt-stepper-element="nav">
                            <h3 class="stepper-title">Datos de Jugador</h3>
                        </div>
                        <!--end::Step 1-->
                        <!--begin::Step 2-->
                        ...
                        <div class="current" data-kt-stepper-element="content">
                            ...
                            <div class="w-100">
                                ...
                                <div class="mb-10 fv-row">
                                    <!--begin::Label-->
                                    <label class="required form-label mb-3">Introduce el Nombre del jugador</label>
                                    <!--end::Label-->
                                    <!--begin::Input-->
