                            ...
                            <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                                ...
                                <div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
                                    ...
                                    <h1 class="page-heading d-flex flex-column justify-content-center text-dark fw-bold fs-3 m-0">
                                        Detalles de Escuela</h1>
                                    <!--end::Title-->
                                    <!--begin::Breadcrumb-->
                                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0">
                                        <!--begin::Item-->
                                        <li class="breadcrumb-item text-muted">
                                            <a href="../../demo55/dist/utilities/modals/wizards/upload-escuela.php"
                                               class="text-muted text-hover-primary">Escuelas</a>
                                        </li>
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <li class="breadcrumb-item text-muted">Detalles</li>
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                                                        ...
                                                        <div class="d-flex flex-column">
                                                            ...
                                                            <div class="d-flex flex-wrap fw-semibold fs-6 mb-4 pe-2">
                                                                <a class="d-flex align-items-center text-gray-600 text-hover-primary me-5 mb-2">
                                                                    <i class="fs-4 text-gray-800 text-hover-primary fw-bold mb-0"></i><?php echo $row->Nombre1; ?> <?php echo $row->Nombre2; ?> <?php echo $row->Ape1; ?> <?php echo $row->Ape2; ?>
                                                                </a>
                                                                <a class="d-flex align-items-center text-gray-600 text-hover-primary me-5 mb-2">
                                                                    <i class="ki-outline ki-geolocation fs-4 me-1"></i><?php echo $row->direccion; ?>
                                                                </a>
                                                                <a href="#"
                                                                   class="d-flex align-items-center text-gray-600 text-hover-primary mb-2">
                                                                    <i class="ki-outline ki-sms fs-4 me-1"></i><?php echo $row->ciudad; ?>
                                                                </a>
                                                            </div>
                                                            <!--end::Info-->
                                                        </div>
                                                        ...
                                                        <div class="d-flex my-4">
                                                            <a href="#" class="btn btn-sm btn-primary me-3"
                                                               ...
                                                               data-bs-target="#kt_modal_offer_a_deal">Añadir
                                                                Equipos</a>
                                                            <!--begin::Menu-->
                                                            <div class="me-0">
                                                                ...
                                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px py-3"
                                                                    ...
                                                                    <!--begin::Menu item-->
                                                                    <div class="menu-item px-3">
                                                                        <a href="#" class="menu-link px-3">Ver RUT</a>
                                                                    </div>
                                                                    <!--end::Menu item-->
                                                                    <!--begin::Menu item-->
                                                                    <div class="menu-item px-3"
                                                                         ...
                                                                         data-kt-menu-placement="right-end">
                                                                        <a href="#" class="menu-link px-3">
                                                                            <span class="menu-title">Añadir a</span>
                                                                            <span class="menu-arrow"></span>
                                                                        </a>
                                                                        <!--begin::Menu sub-->
                                                                        <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                                                            ...
                                                                            <div class="menu-item px-3">
                                                                                <a href="#" class="menu-link px-3"
                                                                                   data-bs-toggle="modal"
                                                                                   data-bs-target="#kt_modal_create_campaign">Jugadores</a>
                                                                            </div>
                                                                            <!--end::Menu item-->
                                                                            <!--begin::Menu item-->
                                                                            <div class="menu-item px-3">
                                                                                <a href="#" class="menu-link px-3">Representante
                                                                                    Legal</a>
                                                                            </div>
                                                                            <!--end::Menu item-->
                                                                            <!--begin::Menu item-->
                                                                            <div class="menu-item px-3">
                                                                                <a href="#" class="menu-link px-3">Registro
                                                                                    RUT</a>
                                                                            </div>
                                                                        </div>
                                                                        <!--end::Menu sub-->
                                                                    ...
                                                                    <!--begin::Menu item-->
                                                                    <div class="menu-item px-3">
                                                                        <a href="#" class="menu-link px-3">Editar
                                                                            Información <span class="ms-2"
                                                                                              data-bs-toggle="tooltip"
                                                                                              title="Ten cuidado al cambiar información de la escuela">
																			<i class="ki-outline ki-information fs-6"></i>
																		</span></a>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="d-flex flex-column flex-grow-1 pe-8">
                                                            ...
                                                            <div class="d-flex flex-wrap">
                                                                ...
                                                                <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                                                    <!--begin::Number-->
                                                                    <div class="d-flex align-items-center">
                                                                        <i class="ki-duotone ki-emoji-happy fs-3 text-success me-2">
                                                                    ...
                                                                    <!--end::Number-->
                                                                    <!--begin::Label-->
                                                                    <div class="fw-semibold fs-6 text-gray-400">Recuento
                                                                        de Jugadores
                                                                    </div>
                                                                    <!--end::Label-->
                                                                </div>
                                                                ...
                                                                <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                                                    ...
                                                                    <!--end::Number-->
                                                                    <!--begin::Label-->
                                                                    <div class="fw-semibold fs-6 text-gray-400">Partidos
                                                                        Perdidos
                                                                    </div>
                                                                    <!--end::Label-->
                                                                </div>
                                            ...
                                            <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
                                                ...
                                                <li class="nav-item mt-2">
                                                    <a class="nav-link text-active-primary ms-0 me-10 py-5"
                                                       href="../../demo55/dist/pages/user-profile/followerso1.php?datosescue=<?php echo $varsearch; ?>">Equipos</a>
                                                </li>
                                            </ul>
                            ...
                            <div class="d-flex flex-wrap flex-stack mb-6">
                                ...
                                <h3 class="text-gray-800 fw-bold my-2">Jugadores
                                    <span class="fs-6 text-gray-400 fw-semibold ms-1">(<?php
                                        include('\laragon\www\RFIDPLAY\main\conexion.php');
                                        $sql = $mysqli->query("SELECT count(id_jugador)as total FROM jugadores inner join rfidplay.escuelasdefutbol e on jugadores.id_escuela = e.id_escuela
where jugadores.id_escuela = '$varsearch'");
                                        if ($sql->num_rows != 0) {
                                            while ($row = $sql->fetch_object()) {
                                                echo $row->total;
                                            }
                            ...
                            <div class="row g-6 mb-6 g-xl-9 mb-xl-9" id="jugadoresContainer">
                                <?php
                                include('\laragon\www\RFIDPLAY\main\conexion.php');
                                $sql = $mysqli->query("SELECT * FROM jugadores
    INNER JOIN rfidplay.documentos d on jugadores.id_documento = d.id_documento
WHERE id_escuela = '$varsearch'");
                                if ($sql->num_rows != 0) {
                                    while ($row = $sql->fetch_object()) {
                                        ?>
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body d-flex flex-center flex-column py-9 px-5">
                                                    ...
                                                    <div class="symbol symbol-65px symbol-circle mb-5">
                                                        <img src="data:image/jpg;base64,<?php echo base64_encode($row->documentosfoto) ?>"
                                                             alt="image"/>
                                                    ...
                                                    <!--begin::Name-->
                                                    <a href="#"
                                                       class="fs-4 text-gray-800 text-hover-primary fw-bold mb-0"><?php echo $row->Nombre1 . ' ' . $row->Nombre2 . ' ' . $row->Ape1 . ' ' . $row->Ape2; ?></a>
                                                    <!--end::Name-->
                                                    <!--begin::Position-->

                                                    <div class="fw-semibold text-gray-400 mb-6">
                                                        <?php
                                                        $sqleq = $mysqli->query("SELECT * FROM equipos INNER JOIN rfidplay.jugador_equipo je on equipos.id_equipo = je.equipofk
    INNER JOIN rfidplay.tip_equi_age tea on equipos.fk_type_equipo = tea.idtip_equi_age WHERE idjugadorfk =  ' $row->id_jugador'");
                                                        if ($sqleq->num_rows != 0) {
                                                            while ($roweq = $sqleq->fetch_object()) {
                                                                ?>
                                                                <?php echo $roweq->nombre_equipo ?>
                                                                (<?php echo $roweq->Descripcion ?>)

                                                            <?php }
                                                        } else { ?>
                                                            NO TIENE ASIGNADO EQUIPOS AÚN
                                                        <?php } ?>
                                                    ...
                                                    <div class="me-0">
                                                        ...
                                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px py-3"
                                                            ...
                                                            <div class="menu-item px-3"
                                                                 ...
                                                                 data-kt-menu-placement="right-end">
                                                                <a href="#" class="menu-link px-3">
                                                                    <span class="menu-title">Añadir sobre esta</span>
                                                                    <span class="menu-arrow"></span>
                                                                </a>
                                                                <!--begin::Menu sub-->
                                                                <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="card-px text-center pt-15 pb-15">
                                            <!--begin::Title-->
                                            <h2 class="fs-2x fw-bold mb-0">Añade jugadores a esta escuela</h2>
                                            <!--end::Title-->
                                            <!--begin::Description-->
                                            <p class="text-gray-400 fs-4 fw-semibold py-7">Antes de empezar ten a la
                                                mano los
                                                datos del jugador.</p>
                                        </div>
                                        <!--end::Heading-->
...
<!--end::Modal - Modal para crear un equipo-->
...
<div class="modal fade" id="kt_modal_offer_a_deal" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered mw-1000px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header py-7 d-flex justify-content-between">
                <!--begin::Modal title-->
                <h2>Crea equipos y añade jugadores</h2>
                <!--end::Modal title-->
                <!--begin::Close-->
                <div class="btn btn-sm btn-icon btn-active-color-primary" data-bs-dismiss="modal">
                    <i class="ki-outline ki-cross fs-1"></i>
                ...
                <div class="stepper stepper-links d-flex flex-column" id="kt_modal_offer_a_deal_stepper">
                    ...
                    <div class="stepper-nav justify-content-center py-2">
                        ...
                        <div class="stepper-item me-5 me-md-15 current" data-kt-stepper-element="nav">
                            <h3 class="stepper-title">Define el equipo</h3>
                        </div>
                        <!--end::Step 1-->
                        <!--begin::Step 2-->
                        <div class="stepper-item me-5 me-md-15" data-kt-stepper-element="nav">
                            <h3 class="stepper-title">Añadamos algunos</h3>
                        </div>
                        <!--begin::Step 4-->
                        <div class="stepper-item" data-kt-stepper-element="nav">
                            <h3 class="stepper-title">Confirma</h3>
                        </div>
                        <!--end::Step 4-->
                    </div>
                    <!--end::Nav-->
                    ...
                    <form class="mx-auto mw-500px w-100 pt-15 pb-10" novalidate="novalidate"
                          id="kt_modal_offer_a_deal_form" enctype="multipart/form-data">
                        <!--begin::Type-->
                            ...
                            <div class="w-100">
                                ...
                                <div class="mb-13">
                                    ...
                                    <div class="text-muted fw-semibold fs-5">Al seleccionar por categoria solo se
                                        mostraran los jugadores que coincdan con la edad de categoria elegida si eliges
                                        por equipos tendras la posibilidad de añadir los jugadores a ese equipo para que
                                        pueda ser listado en otras categorias
 ...
 <span class="path5"></span>
                                            ...
                                            <!--begin::Info-->
													<span class="ms-4">
                                                            <span class="fs-3 fw-bold text-gray-900 mb-2 d-block">Equipo Múltiple</span>
														<span class="fw-semibold fs-4 text-muted">Los jugadores que se registren en este equipo podrán pertenecer a varios con esta cualidad</span>
													</span>
                                            <!--end::Info-->
												</span>
                                        <!--end::Label-->
 ...
 <span class="path2"></span>></i>
                                            ...
                                            <!--begin::Info-->
													<span class="ms-4">
														<span class="fs-3 fw-bold text-gray-900 mb-2 d-block">Equipo por categoria</span>
														<span class="fw-semibold fs-4 text-muted">Los jugadores que se registren en este equipo solo podrán pertenecer a este equipo.</span>
													</span>
                                            <!--end::Info-->
												</span>
                                        <!--end::Label-->
                        ...
                        <div data-kt-stepper-element="content">
                            ...
                            <div class="w-100">
                                ...
                                <div class="mb-13">
                                    ...
                                    <!--end::Title-->
                                    <!--begin::Description-->
                                    <div class="text-muted fw-semibold fs-5">Escribe la caracteristica principal del
                                        equipo
                                ...
                                <div class="fv-row mb-8">
                                    <!--begin::Label-->
                                    <label class="required fs-6 fw-semibold mb-2">Nombre del equipo</label>
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" class="form-control form-control-solid"
                                           placeholder="Escribe el nombre del equipo" name="name_team" id="name_team"/>
                                    <!--end::Input-->
                                </div>
                                <div class="d-flex flex-stack">
                                    <button type="button" class="btn btn-lg btn-light me-3"
                                            data-kt-element="details-previous">Atras
                                    </button>
                    ...
                    <script>
                        $(document).ready(function () {
                            ...
                            $("#submitFormButton").click(function (event) {
                                ...
                                formData.append("e_name_team", e_name_team);
                                formData.append("e_type_team", e_type_team);
                                formData.append("esid", <?php echo $varsearch; ?>);

                                $.ajax({
                                    url: "../../demo55/dist/pages/user-profile/php/guardar_equipo.php",
                                    type: "POST",
                                    data: formData,
                                    processData: false,
                                    contentType: false,
                                    success: function (response) {
                                        ...
                                        Swal.fire({
                                            ...
                                            $('#kt_modal_offer_a_deal_stepper').modal('hide');

                                            // Reinicia el contenido del modal cuando se cierra
                                            $('#kt_modal_offer_a_deal_stepper').on('hidden.bs.modal', function () {
...
<div class="modal fade" id="kt_modal_create_campaign" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-fullscreen p-9">
        ...
        <div class="modal-content modal-rounded">
            ...
            <div class="modal-header py-7 d-flex justify-content-between">
                <!--begin::Modal title-->
                <h2>Añadir Jugador a <?php echo $nameescul; ?></h2>
                <!--end::Modal title-->
                <!--begin::Close-->
                <div class="btn btn-sm btn-icon btn-active-color-primary" data-bs-dismiss="modal">
                    <i class="ki-outline ki-cross fs-1"></i>
                        ...
                        <div class="current" data-kt-stepper-element="content">
                            ...
                            <div class="w-100">
                                ...
                                <div class="pb-10 pb-lg-15">
                                    <!--begin::Title-->
                                    <h2 class="fw-bold d-flex align-items-center text-dark">Añade los datos personales
                                        del Jugador
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <span class="ms-1" data-bs-toggle="tooltip"
                                          title="Pon el nombre completo separado por espacios">
                                            <i class="ki-outline ki-information-5 text-gray-500 fs-6"></i>
                                            </span></h2>
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" class="form-control form-control-lg form-control-solid"
                                           name="player_name" placeholder="" value=""/>
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                                <!--begin::Input group-->
                                <div class="fv-row mb-10">
                                    ...
                                    <label class="d-block fw-semibold fs-6 mb-5">
                                        ...
                                        <span class="ms-1" data-bs-toggle="tooltip"
                                              title="Selecciona una foto donde el jugador">
													<i class="ki-outline ki-information-5 text-gray-500 fs-6"></i>
												</span>
                                    </label>
                                    <!--end::Label-->
                                ...
                                <div class="mb-10">
                                    ...
                                    <div class="d-flex fv-row">
                                        <select class="form-select" data-control="select2" id="escuelaSelect"
                                                data-placeholder="Selecciona una Escuela">
                                            <option></option>
                                            <?php
                                            $query = "SELECT id_escuela, nombre_escuela, direccion, ciudad, fotoes FROM escuelasdefutbol where id_escuela = '$varsearch'";
                                            $result = mysqli_query($mysqli, $query);

                                            while ($row = mysqli_fetch_assoc($result)) {
                                                $selected = ($varsearch == $row['id_escuela']) ? 'selected' : ''; // Verificar si es igual a $varsearch
                                                echo '<option value="' . $row['id_escuela'] . '" ' . $selected . '>' . $row['nombre_escuela'] . '</option>';
                                            }
                                            ?>
                                        </select>
                                    </div>
                                    ...
                                    <div class="fv-row mb-10">
                                        <select class="form-select form-select-lg form-select-solid"
                                                data-control="select2" data-placeholder="Selecciona un Equipo"
                                                data-allow-clear="true" multiple="multiple" id="equiposSelect"></select>
                                    </div>
                                </div>
                                ...
                                <script>
                                    $(document).ready(function () {
                                        ...
                                        equiposSelect.select2();
                                        $.post("../../demo55/dist/utilities/modals/wizards/php/obtener_equipos.php", {escuelaId: '<?php echo $varsearch; ?>'}, "json")
                        ...
                        <div data-kt-stepper-element="content">
                            ...
                            <div class="w-100">
                                ...
                                <div class="d-flex fv-row mb-3"><!-- Wrap select and input in a flex container -->
                                    ...
                                    <input type="number" name="identificationc" class="form-control" id="idcard"
                            ...
                            <div class="w-100">
                                ...
                                <div class="fv-row mb-10">
                                    ...
                                    <label class="fs-6 fw-semibold mb-2">R-CARD
                                        <span class="ms-1" data-bs-toggle="tooltip"
                                              title="Usa el sensor RFID proporcionado y escanea la tarjeta para asignar">
												<i class="ki-outline ki-information-5 text-gray-500 fs-6"></i>
											</span></label>
                                    <!--End::Label-->
                                    <!--begin::Row-->
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/pdf.js/3.10.111/pdf.sandbox.min.js"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/pdf.js/3.10.111/pdf.worker.entry.min.js"></script>
...
<script>
    ...
    $(document).ready(function () {
        $('.open-cc-modal').on('click', function () {
            // Get the player ID and full name from the data attributes
            ...
            $.ajax({
                ...
                success: function (pdfUrl) {
                    ...
                    // Show the iframe and hide the fallback message
                    pdfViewer.show();
                    $('#fallbackMessage').hide();

                    // Update the <h2> with the player's full name
                    $('#playerFullName').text('Copia de documento de ' + playerName);

                    // Show the modal
                    $('#kt_modal_open_cc').modal('show');
                },
                error: function (xhr, status, error) {
                    console.error('Error fetching PDF content:', error);

                    // If there's an error, hide the iframe and show the fallback message
                    $('#pdfViewer').hide();
...
<!--modal para abrir cc- -->
<div class="modal fade" id="kt_modal_open_cc" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-fullscreen p-9">
        <!--begin::Modal content-->
        <div class="modal-content modal-rounded">
