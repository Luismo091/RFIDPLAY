                                    ...
                                    <div class="card mb-6">
                                        <div class="card-body pt-9 pb-0 ">
                                                        ...
                                                        <div class="d-flex flex-column">
                                                            ...
                                                            <div class="d-flex flex-wrap fw-semibold fs-6 mb-4 pe-2">
                                                                <a class="d-flex align-items-center text-gray-600 text-hover-primary me-5 mb-2">
                                                                    <i class="fs-4 text-gray-800 text-hover-primary fw-bold mb-0"></i><?php echo $row->nombre_escuela; ?>
                                                                </a>
                                                                <a class="d-flex align-items-center text-gray-600 text-hover-primary me-5 mb-2">
                                                        ...
                                                        <div class="d-flex my-4">
                                                            <a href="#" class="btn btn-sm btn-light me-2"
                                                               id="kt_user_follow_button">
                                                                ...
                                                                <span class="indicator-label">Seguimiento</span>
                                                                <!--end::Indicator label-->
                                                                ...
                                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px py-3"
                                                                    ...
                                                                    <div class="menu-item px-3"
                                                                        ...
                                                                        <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                                                            <!--begin::Menu item-->
                                                                            <div class="menu-item px-3">
                                                                                <a href="#" class="menu-link px-3">Jugadores</a>
                                                                            </div>
                                                                            <!--end::Menu item-->
                                                                            <!--begin::Menu item-->
                                                                            <div class="menu-item px-3">
                                            ...
                                            <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
                                                ...
                                                <li class="nav-item mt-2">
                                                    <a class="nav-link text-active-primary ms-0 me-10 py-5 active"
                                                       href="../../demo55/dist/pages/user-profile/followerso1.php?datosescue=<?php echo $varsearch; ?>">Escuelas</a>
                                                </li>
                                            </ul>
